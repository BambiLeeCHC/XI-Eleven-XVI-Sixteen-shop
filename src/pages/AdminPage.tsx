    ...
    <aside className="w-56 shrink-0 border-r border-white/[0.06] bg-[#0c0c0c] min-h-screen">
      <div className="p-5 border-b border-white/[0.06]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium tracking-wide text-[#1a1a2e]/90">
            Admin
          </span>
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-[13px] transition-all ${
                isActive
                  ? "bg-white/[0.08] text-[#1a1a2e]"
                  : "text-[#1a1a2e]/40 hover:text-[#1a1a2e]/70 hover:bg-white/[0.04]"
              }`}
            >
...
function StatCard({
  ...
  return (
    <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
      ...
      <div className="text-xl font-semibold text-[#1a1a2e]/90">{value}</div>
    </div>
  );
}
  ...
  return (
    <span
      className={`px-2 py-0.5 rounded-full text-[11px] font-medium border ${
        styles[status] || "bg-white/5 text-[#1a1a2e]/50 border-white/10"
      }`}
    >
      {status}
    </span>
...
function DashboardTab() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-lg font-medium text-[#1a1a2e]/90">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
          <h3 className="text-[11px] tracking-wider uppercase text-[#1a1a2e]/40 mb-4">
          ...
          {revenueData.length > 0 ? (
            ...
            <div className="h-60 flex items-center justify-center text-[#1a1a2e]/20 text-sm">
              No revenue data yet
            </div>
          )}
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
          ...
          {categoryData.length > 0 ? (
              ...
              <div className="space-y-1 mt-2">
                {categoryData.map((d, i) => (
                  <div key={d.name} className="flex items-center gap-2 text-xs">
                    ...
                    />
                    <span className="text-[#1a1a2e]/50">{d.name}</span>
                    <span className="ml-auto text-[#1a1a2e]/70">
                      ${d.value.toFixed(0)}
                    </span>
                  </div>
                ))}
            ...
            <div className="h-48 flex items-center justify-center text-[#1a1a2e]/20 text-sm">
              No data yet
            </div>
          )}
        </div>
      ...
      {stats.topProducts.length > 0 && (
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
          <h3 className="text-[11px] tracking-wider uppercase text-[#1a1a2e]/40 mb-3">
            Top Products
          </h3>
            ...
            {stats.topProducts.map((p: any, i: number) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="text-[#1a1a2e]/20 text-xs w-4">{i + 1}</span>
                  <span className="text-sm text-[#1a1a2e]/70">{p.name}</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-xs text-[#1a1a2e]/40">
                    {p.units} units
                  </span>
                  <span className="text-sm font-medium text-[#1a1a2e]/80">
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-medium text-[#1a1a2e]/90">Orders</h1>
        <span className="text-xs text-[#1a1a2e]/30">{orders.length} total</span>
      </div>

      {/* Filters */}
      <div className="flex gap-3">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1a1a2e]/20" />
          <input
            type="text"
            placeholder="Search by email, order ID, or product..."
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md pl-9 pr-3 py-2 text-sm text-[#1a1a2e]/80 placeholder-white/20 focus:outline-none focus:border-white/20"
          />
        </div>
        <div className="flex items-center gap-1 bg-white/[0.04] border border-white/[0.08] rounded-md px-2">
          <Filter className="w-3.5 h-3.5 text-[#1a1a2e]/20" />
          <select
            value={statusFilter}
            onChange={(e) => setStatusFilter(e.target.value)}
            className="bg-transparent text-sm text-[#1a1a2e]/60 py-2 pr-2 focus:outline-none"
          >
            {statuses.map((s) => (
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg overflow-hidden">
        <table className="w-full">
            ...
            <tr className="border-b border-white/[0.06]">
              {["Date", "Customer", "Items", "Total", "Status", ""].map(
                (h) => (
                  <th
                    key={h}
                    className="px-4 py-2.5 text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/30 font-medium"
                  >
                    {h}
                  </th>
                )
          ...
          <tbody>
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={6} className="px-4 py-8 text-center text-[#1a1a2e]/20 text-sm">
                  No orders found
                </td>
              </tr>
            ) : (
              filtered.map((order: any) => (
                ...
                >
                  <td className="px-4 py-3 text-xs text-[#1a1a2e]/50">
                  ...
                  <td className="px-4 py-3">
                    <div className="text-sm text-[#1a1a2e]/70">{order.email}</div>
                    <div className="text-[11px] text-[#1a1a2e]/25">
                  ...
                  <td className="px-4 py-3 text-sm font-medium text-[#1a1a2e]/80">
                  ...
                  <td className="px-4 py-3">
                    <button
                      ...
                      className="text-[#1a1a2e]/30 hover:text-[#1a1a2e]/70 transition-colors"
                    >
    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4">
      <div className="bg-[#111] border border-white/[0.08] rounded-xl w-full max-w-2xl max-h-[85vh] overflow-y-auto">
        <div className="flex items-center justify-between p-5 border-b border-white/[0.06]">
          <div>
            <h2 className="text-sm font-medium text-[#1a1a2e]/90">Order Details</h2>
            <p className="text-[11px] text-[#1a1a2e]/30 mt-0.5 font-mono">
              {order._id}
            </p>
          </div>
          <button
            onClick={onClose}
            className="text-[#1a1a2e]/30 hover:text-[#1a1a2e]/70"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[10px] tracking-wider uppercase text-[#1a1a2e]/30">
                Customer
              </label>
              <p className="text-sm text-[#1a1a2e]/80 mt-1">{order.email}</p>
            </div>
            <div>
              <label className="text-[10px] tracking-wider uppercase text-[#1a1a2e]/30">
                Date
              ...
              {order.items?.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-[#1a1a2e]/70 truncate">
                      {item.productName}
                    </p>
          ...
          <div className="bg-white/[0.03] rounded-md p-3 space-y-1.5">
            <div className="flex justify-between text-xs text-[#1a1a2e]/40">
              <span>Subtotal</span>
            ...
            <div className="flex justify-between text-sm font-medium text-[#1a1a2e]/80 pt-1.5 border-t border-white/[0.06]">
              <span>Total</span>
          ...
          {order.shippingAddress && (
            <div>
              ...
              <div className="mt-1 text-sm text-[#1a1a2e]/60 leading-relaxed">
                ...
                {order.shippingAddress.phone && (
                  <p className="mt-1 text-[#1a1a2e]/40">
                    📞 {order.shippingAddress.phone}
                  </p>
                )}
              </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-[11px]">
            {order.stripeCheckoutSessionId && (
              <div>
                <span className="text-[#1a1a2e]/25">Stripe Session:</span>{" "}
                <span className="text-[#1a1a2e]/50 font-mono break-all">
                  {order.stripeCheckoutSessionId}
                </span>
              </div>
            )}
            {order.printfulOrderId && (
              <div>
                <span className="text-[#1a1a2e]/25">Printful Order:</span>{" "}
                <span className="text-[#1a1a2e]/50 font-mono">
                  {order.printfulOrderId}
                </span>
              </div>
            )}
          ...
          <div className="border-t border-white/[0.06] pt-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[10px] text-[#1a1a2e]/25 mb-1 block">
                  Status
                </label>
                <select
                  value={newStatus}
                  onChange={(e) => setNewStatus(e.target.value)}
                  className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md px-3 py-2 text-sm text-[#1a1a2e]/70 focus:outline-none"
                >
                  {[
                    "pending",
                    "paid",
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md px-3 py-2 text-sm text-[#1a1a2e]/70 placeholder-white/15 focus:outline-none"
                />
              </div>
              <div>
                <label className="text-[10px] text-[#1a1a2e]/25 mb-1 block">
...
function ProductsTab() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-medium text-[#1a1a2e]/90">Products</h1>
        <span className="text-xs text-[#1a1a2e]/30">
          ...
          >
            {editingId === product._id ? (
              ...
              <div className="p-4 space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-[10px] text-[#1a1a2e]/25 block mb-1">
                      Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-white/[0.04] border border-white/[0.08] rounded px-3 py-1.5 text-sm text-[#1a1a2e]/80 focus:outline-none"
                    />
                  </div>
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-white/[0.04] border border-white/[0.08] rounded px-2 py-1.5 text-sm text-[#1a1a2e]/70 focus:outline-none"
                      >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/[0.04] border border-white/[0.08] rounded px-3 py-1.5 text-sm text-[#1a1a2e]/80 focus:outline-none resize-none"
                  />
                </div>
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 text-sm text-[#1a1a2e]/60">
                    <input
                      type="checkbox"
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-3 py-1.5 text-xs text-[#1a1a2e]/40 hover:text-[#1a1a2e]/60"
                    >
                      Cancel
                    </button>
                    <button
              ...
              <div className="flex items-center gap-4 p-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="text-sm text-[#1a1a2e]/80 truncate">
                      {product.name}
                    </p>
                    {!product.isActive && (
                ...
                <span className="text-sm font-medium text-[#1a1a2e]/70 tabular-nums">
                  ${(product.price / 100).toFixed(2)}
                </span>
                <button
                  onClick={() => startEdit(product)}
                  className="text-[#1a1a2e]/20 hover:text-[#1a1a2e]/60 transition-colors p-1"
                >
...
function CustomersTab({
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-medium text-[#1a1a2e]/90">Customers</h1>
        <span className="text-xs text-[#1a1a2e]/30">{customers.length} total</span>
      </div>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((customer: any) => (
                ...
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-white/[0.06] flex items-center justify-center text-xs text-[#1a1a2e]/40">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${
                        customer.role === "admin"
                          ...
                          : "bg-white/5 text-[#1a1a2e]/30 border border-white/10"
                      }`}
                    >
                  ...
                  <td className="px-4 py-3 text-xs text-[#1a1a2e]/40">
                  ...
                  <td className="px-4 py-3">
                    <button
                      ...
                      className="text-[#1a1a2e]/30 hover:text-amber-400 transition-colors text-xs"
                    >
                      CRM →
                    </button>
                  </td>
...
function CrmTab({ preselectedCustomerId }: { preselectedCustomerId?: string }) {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-lg font-medium text-[#1a1a2e]/90">CRM</h1>

      <div className="grid grid-cols-3 gap-4">
        {/* Customer List */}
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg">
          <div className="p-3 border-b border-white/[0.06]">
            <p className="text-[11px] tracking-wider uppercase text-[#1a1a2e]/30">
              Customers
            </p>
          </div>
          <div className="max-h-[60vh] overflow-y-auto">
            {customers.map((c: any) => (
              ...
              >
                <div className="w-7 h-7 rounded-full bg-white/[0.06] flex items-center justify-center text-[10px] text-[#1a1a2e]/40 shrink-0">
                  {(c.name || c.email || "?")[0]?.toUpperCase()}
                </div>
                <div className="min-w-0">
                  <p className="text-xs text-[#1a1a2e]/70 truncate">
                    {c.name || c.email || "Unknown"}
                  </p>
                  <p className="text-[10px] text-[#1a1a2e]/25 truncate">
            ...
            {customers.length === 0 && (
              <p className="p-4 text-center text-[#1a1a2e]/20 text-xs">
                No customers yet
              </p>
            )}
          </div>
        ...
        <div className="col-span-2">
          {selectedCustomer ? (
            ...
            <div className="h-full bg-white/[0.03] border border-white/[0.06] rounded-lg flex items-center justify-center">
              <p className="text-[#1a1a2e]/20 text-sm">
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-white/[0.06] flex items-center justify-center text-lg text-[#1a1a2e]/40">
              {(customer.name || customer.email || "?")[0]?.toUpperCase()}
            </div>
            <div>
              <h2 className="text-sm font-medium text-[#1a1a2e]/90">
                {customer.name || "Unknown"}
              </h2>
              <p className="text-xs text-[#1a1a2e]/40">{customer.email}</p>
              <div className="flex items-center gap-3 mt-1 text-[11px] text-[#1a1a2e]/30">
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded text-[10px] font-medium transition-colors ${
                customer.role === "admin"
                  ...
                  : "bg-white/5 text-[#1a1a2e]/30 hover:bg-white/10"
              }`}
            >
        ...
        <div className="mt-3 flex items-center gap-2 flex-wrap">
          {tags.map((tag: string, i: number) => (
            <span
              key={i}
              className="flex items-center gap-1 px-2 py-0.5 bg-white/[0.06] rounded-full text-[10px] text-[#1a1a2e]/50"
            >
              ...
              <button
                ...
                className="ml-0.5 text-[#1a1a2e]/20 hover:text-[#1a1a2e]/50"
              >
                ×
              </button>
            </span>
          ...
          >
            <input
              ...
              placeholder="+ Add tag"
              className="bg-transparent text-[10px] text-[#1a1a2e]/40 placeholder-white/15 w-16 focus:w-24 focus:outline-none transition-all"
            />
          </form>
        </div>
      </div>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
        ...
        <div className="flex gap-2">
          <textarea
            ...
            className="flex-1 bg-white/[0.04] border border-white/[0.08] rounded-md px-3 py-2 text-sm text-[#1a1a2e]/70 placeholder-white/15 focus:outline-none resize-none"
          />
          <button
      ...
      {/* Notes Timeline */}
      <div className="space-y-2">
        <h3 className="text-[11px] tracking-wider uppercase text-[#1a1a2e]/30">
          ...
          return (
            ...
            >
              <div className="w-7 h-7 rounded-md bg-white/[0.06] flex items-center justify-center shrink-0">
                <Icon className="w-3.5 h-3.5 text-[#1a1a2e]/30" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="text-[10px] font-medium text-[#1a1a2e]/50">
                    {typeInfo.label}
                  </span>
                  <span className="text-[10px] text-[#1a1a2e]/20">
                    by {note.adminName}
                  </span>
                  <span className="text-[10px] text-[#1a1a2e]/15 ml-auto">
                    {format(new Date(note.createdAt), "MMM d, h:mm a")}
                  </span>
                </div>
                <p className="text-xs text-[#1a1a2e]/60 whitespace-pre-wrap">
                  {note.note}
                </p>
              </div>
              <button
                onClick={() => deleteNote({ noteId: note._id })}
                className="text-[#1a1a2e]/10 hover:text-red-400 transition-colors self-start"
              >
        ...
        {(!notes || notes.length === 0) && (
          <p className="text-center text-[#1a1a2e]/15 text-xs py-6">
...
function NewsletterTab() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-medium text-[#1a1a2e]/90">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-white/[0.06] rounded-md text-xs text-[#1a1a2e]/50 hover:text-[#1a1a2e]/80 transition-colors"
          >
            Export CSV
          </button>
        </div>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg overflow-hidden">
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/[0.06]">
              <th className="px-4 py-2.5 text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/30 font-medium">
                Email
              </th>
              <th className="px-4 py-2.5 text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/30 font-medium">
                Subscribed
              </th>
              <th className="px-4 py-2.5 text-right text-[10px] tracking-wider uppercase text-[#1a1a2e]/30 font-medium">
                Actions
              </th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((sub: any) => (
              ...
              >
                <td className="px-4 py-2.5 text-sm text-[#1a1a2e]/70">
                  {sub.email}
                </td>
                <td className="px-4 py-2.5 text-xs text-[#1a1a2e]/40">
                  {format(new Date(sub.subscribedAt), "MMM d, yyyy")}
                </td>
                <td className="px-4 py-2.5 text-right">
                  <button
                    onClick={() => removeSubscriber({ subscriberId: sub._id })}
                    className="text-[#1a1a2e]/15 hover:text-red-400 transition-colors"
                  >
...
function SettingsTab() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-lg font-medium text-[#1a1a2e]/90">Settings</h1>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-5 space-y-4">
        ...
        <div className="space-y-1">
          {admins.length === 0 && (
            <p className="text-xs text-[#1a1a2e]/20 py-2">No admin users</p>
          )}
          {admins.map((admin: any) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-[#1a1a2e]/80">{admin.name || "—"}</p>
                  <p className="text-[11px] text-[#1a1a2e]/30">{admin.email}</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                {confirmRemove === admin._id ? (
                  <div className="flex items-center gap-1.5 animate-in fade-in">
                    ...
                    <button
                      ...
                      className="px-2 py-0.5 rounded text-[10px] bg-white/5 text-[#1a1a2e]/30 hover:bg-white/10 transition-colors"
                    >
                      No
                    </button>
                  </div>
        ...
        {showAddAdmin && (
          <div className="border border-amber-500/10 bg-amber-500/[0.03] rounded-lg p-4 space-y-3 animate-in slide-in-from-top-2">
            ...
            <div className="relative">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#1a1a2e]/20" />
              <input
                type="text"
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                placeholder="Search by name or email..."
                className="w-full bg-white/[0.05] border border-white/[0.08] rounded-md pl-9 pr-3 py-2 text-sm text-[#1a1a2e]/80 placeholder-white/20 focus:outline-none focus:border-amber-500/30"
                autoFocus
              />
            </div>
            ...
            {search.trim() && (
              <div className="max-h-56 overflow-y-auto space-y-1 rounded-md">
                {filteredNonAdmins.length === 0 ? (
                  <p className="text-xs text-[#1a1a2e]/20 text-center py-3">
                  ...
                  filteredNonAdmins.map((user: any) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-7 h-7 rounded-full bg-white/[0.06] flex items-center justify-center text-[11px] text-[#1a1a2e]/40">
                      ...
                      {confirmGrant === user._id ? (
                        <div className="flex items-center gap-1.5 animate-in fade-in">
                          ...
                          <button
                            ...
                            className="px-2 py-1 rounded text-[10px] bg-white/5 text-[#1a1a2e]/30 hover:bg-white/10 transition-colors"
                          >
                            No
                          </button>
                        </div>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-5 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <label className="text-[10px] text-[#1a1a2e]/25">Brand</label>
            <p className="text-[#1a1a2e]/60">XI Eleven XVI Sixteen</p>
          </div>
          <div>
            <label className="text-[10px] text-[#1a1a2e]/25">Contact</label>
            <p className="text-[#1a1a2e]/60">xixvi1116@icloud.com</p>
          </div>
          <div>
            <label className="text-[10px] text-[#1a1a2e]/25">Store URL</label>
            <p className="text-[#1a1a2e]/60 break-all">
              xi-xvi-store-b70b82f5.viktor.space
            </p>
          </div>
          <div>
            <label className="text-[10px] text-[#1a1a2e]/25">
              Printful Store ID
            </label>
            <p className="text-[#1a1a2e]/60">17855930</p>
          </div>
        </div>
      </div>
    </div>
...
function ShippingTab() {
  ...
  return (
    <div className="max-w-4xl">
      <h2 className="text-xl text-[#1a1a2e] font-semibold mb-6">Shipping & Fulfillment</h2>

      {/* Settings Card */}
      <div className="p-6 mb-8 rounded-xl" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
        <h3 className="text-sm text-[#1a1a2e]/70 uppercase tracking-wider mb-5">Shipping Settings</h3>

        <div className="space-y-4">
          {/* Free Standard */}
          <div className="flex items-center justify-between py-2">
            <div>
              <p className="text-sm text-[#1a1a2e]/80">Free Standard Shipping</p>
              <p className="text-xs text-[#1a1a2e]/30">Offer free standard shipping on all orders</p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between py-2">
            <div>
              <p className="text-sm text-[#1a1a2e]/80">Show Expedited Options</p>
              <p className="text-xs text-[#1a1a2e]/30">Display expedited shipping at checkout (from Printful rates)</p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between py-2">
            <div>
              <p className="text-sm text-[#1a1a2e]/80">Production Time (days)</p>
              <p className="text-xs text-[#1a1a2e]/30">Made-to-order production window</p>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="number"
              ...
              />
              <span className="text-[#1a1a2e]/30 text-xs">to</span>
              <input
                type="number"
                value={fulfillMax}
        ...
        <button
          onClick={handleSave}
          className="mt-6 px-6 py-2.5 text-xs tracking-wider uppercase font-bold text-[#1a1a2e] rounded-lg transition-all"
          style={{
            background: saved
      ...
      <div className="p-6 rounded-xl" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
        <h3 className="text-sm text-[#1a1a2e]/70 uppercase tracking-wider mb-5">
          Order Fulfillment ({activeOrders.length} active)
        </h3>

        {activeOrders.length === 0 ? (
          <p className="text-sm text-[#1a1a2e]/30 py-8 text-center">No active orders requiring fulfillment.</p>
        ) : (
          <div className="space-y-4">
            {activeOrders.slice(0, 20).map((order: any) => {
              ...
              return (
                <div key={order._id} className="p-4 rounded-lg" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.04)" }}>
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <span className="text-xs text-[#1a1a2e]/40 font-mono">#{order._id.slice(-8)}</span>
                      <span className="text-xs text-[#1a1a2e]/30 ml-3">{order.email}</span>
                    </div>
...
function TaxTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-medium text-[#1a1a2e]/90">Tax & Shipping</h1>
        <div className="flex items-center gap-2">
          <button
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] tracking-wider uppercase text-[#1a1a2e]/30">US States</span>
          </div>
          <p className="text-xl font-medium text-[#1a1a2e]/80">{usStateCount}</p>
        </div>
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            <Globe className="w-4 h-4 text-purple-400/50" />
            <span className="text-[10px] tracking-wider uppercase text-[#1a1a2e]/30">Countries</span>
          </div>
          <p className="text-xl font-medium text-[#1a1a2e]/80">{countryCount}</p>
        </div>
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-1">
            <CheckCircle2 className="w-4 h-4 text-green-400/50" />
            <span className="text-[10px] tracking-wider uppercase text-[#1a1a2e]/30">Active</span>
          </div>
          <p className="text-xl font-medium text-[#1a1a2e]/80">{enabledCount}</p>
        </div>
      </div>
      ...
      {showAdd && (
        <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4 space-y-3">
          <h3 className="text-[11px] tracking-wider uppercase text-[#1a1a2e]/30">Add New Tax Rate</h3>
          <div className="grid grid-cols-4 gap-3">
            <div>
              <label className="text-[10px] text-[#1a1a2e]/25 block mb-1">Type</label>
              <select
                value={newType}
                onChange={(e) => setNewType(e.target.value as any)}
                className="w-full bg-white/[0.04] border border-white/[0.08] rounded px-2 py-1.5 text-xs text-[#1a1a2e]/70"
              >
            ...
            <div>
              <label className="text-[10px] text-[#1a1a2e]/25 block mb-1">Code</label>
              <input
                value={newRegion}
            ...
            <div>
              <label className="text-[10px] text-[#1a1a2e]/25 block mb-1">Label</label>
              <input
                value={newLabel}
            ...
            <div>
              <label className="text-[10px] text-[#1a1a2e]/25 block mb-1">Rate (%)</label>
              <div className="flex gap-2">
                <input
                  value={newRate}
                  onChange={(e) => setNewRate(e.target.value)}
                  placeholder="7.25"
                  className="flex-1 bg-white/[0.04] border border-white/[0.08] rounded px-2 py-1.5 text-xs text-[#1a1a2e]/70"
                />
                <button
                  onClick={handleAdd}
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg overflow-hidden">
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/[0.06]">
              <th className="text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/25 px-4 py-3">Region</th>
              <th className="text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/25 px-4 py-3">Label</th>
              <th className="text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/25 px-4 py-3">Type</th>
              <th className="text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/25 px-4 py-3">Rate</th>
              <th className="text-left text-[10px] tracking-wider uppercase text-[#1a1a2e]/25 px-4 py-3">Status</th>
              <th className="text-right text-[10px] tracking-wider uppercase text-[#1a1a2e]/25 px-4 py-3">Actions</th>
            </tr>
          </thead>
          <tbody>
            {filteredSettings.length === 0 && (
              <tr>
                <td colSpan={6} className="text-center py-8 text-xs text-[#1a1a2e]/20">
            ...
            {filteredSettings.map((setting: any) => (
              <tr key={setting._id} className="border-b border-white/[0.04] hover:bg-white/[0.02] transition-colors">
                ...
                <td className="px-4 py-2.5">
                  <span className="text-xs text-[#1a1a2e]/60">{setting.label}</span>
                </td>
                <td className="px-4 py-2.5">
                ...
                <td className="px-4 py-2.5">
                  {editingId === setting._id ? (
                    <input
                      ...
                      className="w-20 bg-white/[0.06] border border-white/[0.1] rounded px-2 py-1 text-xs text-[#1a1a2e]/70"
                      autoFocus
                    />
                  ) : (
                    <span className="text-xs text-[#1a1a2e]/70 font-medium">
                ...
                <td className="px-4 py-2.5">
                  ...
                  >
                    {setting.enabled ? (
                      ...
                      <>
                        <ToggleLeft className="w-5 h-5 text-[#1a1a2e]/20 group-hover:text-[#1a1a2e]/40" />
                        <span className="text-[10px] text-[#1a1a2e]/20">Disabled</span>
                      </>
                    )}
                  </button>
                </td>
                  ...
                  <div className="flex items-center justify-end gap-1.5">
                    {editingId === setting._id ? (
                      <>
                        ...
                        <button
                          onClick={() => setEditingId(null)}
                          className="p-1 text-[#1a1a2e]/20 hover:text-[#1a1a2e]/50 transition-colors"
                          title="Cancel"
                        >
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-lg p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          <div className="bg-white/[0.02] rounded p-3">
            <span className="text-[#1a1a2e]/25 text-[10px] uppercase tracking-wider">Domestic (US)</span>
            <p className="text-[#1a1a2e]/60 mt-1">3–7 business days</p>
          </div>
          <div className="bg-white/[0.02] rounded p-3">
            <span className="text-[#1a1a2e]/25 text-[10px] uppercase tracking-wider">International</span>
            <p className="text-[#1a1a2e]/60 mt-1">7–21 business days</p>
          </div>
        </div>
        <p className="text-[10px] text-[#1a1a2e]/20">
  ...
  return (
    <div className="flex items-center justify-center h-64">
      <div className="text-center">
        ...
        <p className="text-[11px] tracking-wider uppercase text-[#1a1a2e]/20">
          Loading...
        </p>
      </div>
    </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-lg font-medium text-[#1a1a2e]/70">Access Denied</h1>
          <p className="text-sm text-[#1a1a2e]/30 mt-1">
