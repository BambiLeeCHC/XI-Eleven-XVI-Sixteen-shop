...
function FulfillmentTracker({ stage, history }: { stage?: string; history?: Array<{ stage: string; timestamp: number; note?: string }> }) {
  ...
  return (
    <div className="mt-4 pt-4" style={{ borderTop: "1px solid rgba(74,143,217,0.08)" }}>
      <p className="text-[10px] tracking-[0.15em] uppercase font-semibold mb-3" style={{ color: "rgba(74,143,217,0.5)" }}>
              ...
              <div
                ...
                style={{
                  background: isComplete
                    ? "linear-gradient(135deg, rgba(74,143,217,0.25), rgba(255,158,184,0.2))"
                    : "rgba(74,143,217,0.04)",
                  border: isCurrent
                    ? "2px solid rgba(74,143,217,0.5)"
                    : isComplete
                      ? "1px solid rgba(74,143,217,0.15)"
                      : "1px solid rgba(0,40,80,0.06)",
                  boxShadow: isCurrent ? "0 0 10px rgba(74,143,217,0.2)" : "none",
                }}
                title={s.label}
              >
                {s.icon}
                ...
                <div
                  ...
                  style={{
                    background: i < currentIdx
                      ? "linear-gradient(90deg, rgba(74,143,217,0.3), rgba(255,158,184,0.25))"
                      : "rgba(0,40,80,0.06)",
                  }}
                />
              )}
      ...
      {/* Current stage label */}
      {currentIdx >= 0 && (
        <p className="text-[11px]" style={{ color: "rgba(74,143,217,0.6)" }}>
        ...
        <div className="space-y-4">
          {orders.map((order: any) => (
            <div
              ...
              className="p-6"
              style={{
                background: "rgba(74,143,217,0.02)",
