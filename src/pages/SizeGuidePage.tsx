      ...
      {lines.map((line, i) => {
        ...
        return (
          <g key={i} className="measurement-group" style={{ animationDelay: `${i * 0.15}s` }}>
            ...
            {isVertical ? (
              <>
                <line x1={line.x1 - 1.5} y1={line.y1} x2={line.x1 + 1.5} y2={line.y1} stroke="rgba(17,17,24,0.6)" strokeWidth="0.3" />
                <line x1={line.x2 - 1.5} y1={line.y2} x2={line.x2 + 1.5} y2={line.y2} stroke="rgba(17,17,24,0.6)" strokeWidth="0.3" />
              </>
            ) : (
              <>
                <line x1={line.x1} y1={line.y1 - 1.5} x2={line.x1} y2={line.y1 + 1.5} stroke="rgba(17,17,24,0.6)" strokeWidth="0.3" />
                <line x1={line.x2} y1={line.y2 - 1.5} x2={line.x2} y2={line.y2 + 1.5} stroke="rgba(17,17,24,0.6)" strokeWidth="0.3" />
              </>
            )}
            {/* Label background */}
            <rect
