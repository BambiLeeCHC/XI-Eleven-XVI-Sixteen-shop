  ...
  return (
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <path
        ...
        stroke="rgba(74,143,217,0.5)"
        strokeWidth="0.3"
        className="overlay-path"
      />
      {/* Straps */}
      <line x1="40" y1="14" x2="38" y2="18" stroke="rgba(74,143,217,0.4)" strokeWidth="0.5" />
      <line x1="60" y1="14" x2="62" y2="18" stroke="rgba(74,143,217,0.4)" strokeWidth="0.5" />
      <defs>
        <linearGradient id="dressGradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(74,143,217,0.15)" />
          <stop offset="50%" stopColor="rgba(255,158,184,0.12)" />
          <stop offset="100%" stopColor="rgba(74,143,217,0.08)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <defs>
        <linearGradient id="jerseyGradient" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="100%" stopColor="rgba(74,143,217,0.12)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <defs>
        <linearGradient id="shortsGradient" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="rgba(74,143,217,0.10)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <defs>
        <linearGradient id="leggingsGradient" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="rgba(74,143,217,0.06)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    >
      ...
      {selectedSize && (
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(74,143,217,0.2), rgba(255,158,184,0.15))",
            backdropFilter: "blur(12px)",
            borderRadius: "8px",
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes badgePulse {
          0%, 100% { box-shadow: 0 0 8px rgba(74,143,217,0.2); }
          50% { box-shadow: 0 0 16px rgba(74,143,217,0.4), 0 0 32px rgba(74,143,217,0.1); }
        }
        .sparkle-particle {
        ...
        .mannequin-container {
          box-shadow: 0 0 60px rgba(74,143,217,0.05), 0 0 120px rgba(0,0,0,0.3);
        }
      `}</style>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="mb-6">
              <p className="text-[10px] tracking-[0.2em] uppercase font-semibold mb-3" style={{ color: "rgba(74,143,217,0.55)" }}>
                SELECT YOUR SIZE
              </p>
                    ...
                    style={{
                      ...
                      background:
                        selectedSize === row.size
                          ? "linear-gradient(135deg, rgba(74,143,217,0.2), rgba(255,158,184,0.12))"
                          : "transparent",
                      border:
                        selectedSize === row.size
                          ? "1px solid rgba(74,143,217,0.4)"
                          : "1px solid rgba(0,40,80,0.1)",
                      borderRadius: "10px",
                      boxShadow:
                        selectedSize === row.size
                          ? "0 0 12px rgba(74,143,217,0.15)"
                          : "none",
                    }}
                  >
                    {row.size}
                  ...
                  <tr>
                    {tab.cols.map((col) => (
                      <th
                        ...
                        style={{
                          color: "rgba(74,143,217,0.55)",
                          borderBottom: "1px solid rgba(0,40,80,0.08)",
        ...
        <div
          className="mb-12 p-6"
          style={{
            background: "linear-gradient(135deg, rgba(74,143,217,0.04), rgba(255,158,184,0.02))",
            border: "1px solid rgba(0,40,80,0.08)",
            borderRadius: "16px",
          }}
        >
