  ...
  return (
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <path
        ...
        stroke="rgba(36,139,212,0.6)"
        strokeWidth="0.3"
        className="overlay-path"
      />
      {/* Straps */}
      <line x1="40" y1="14" x2="38" y2="18" stroke="rgba(36,139,212,0.5)" strokeWidth="0.5" />
      <line x1="60" y1="14" x2="62" y2="18" stroke="rgba(36,139,212,0.5)" strokeWidth="0.5" />
      <defs>
        <linearGradient id="dressGradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(36,139,212,0.15)" />
          <stop offset="50%" stopColor="rgba(255,158,184,0.12)" />
          <stop offset="100%" stopColor="rgba(36,139,212,0.08)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <defs>
        <linearGradient id="jerseyGradient" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="100%" stopColor="rgba(36,139,212,0.12)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full" style={{ opacity: selectedSize ? 0.45 : 0.2 }}>
      ...
      <defs>
        <linearGradient id="leggingsGradient" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="rgba(36,139,212,0.06)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "8px",
          border: "1px solid rgba(36,139,212,0.15)",
          zIndex: 5,
        }}
      >
      ...
      {selectedSize && (
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(36,139,212,0.2), rgba(255,158,184,0.15))",
            backdropFilter: "blur(12px)",
            borderRadius: "8px",
            border: "1px solid rgba(36,139,212,0.3)",
            zIndex: 5,
          }}
        >
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes badgePulse {
          0%, 100% { box-shadow: 0 0 8px rgba(36,139,212,0.2); }
          50% { box-shadow: 0 0 16px rgba(36,139,212,0.5), 0 0 32px rgba(36,139,212,0.1); }
        }
        .sparkle-particle {
        ...
        .mannequin-container {
          box-shadow: 0 0 60px rgba(36,139,212,0.05), 0 0 120px rgba(0,0,0,0.3);
        }
      `}</style>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-16">
        ...
        <div className="flex flex-wrap gap-2 mb-10 justify-center">
          {TABS.map((t) => (
            <button
              ...
              style={{
                color: active === t.key ? "white" : "rgba(21,36,61,0.55)",
                background:
                  active === t.key
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-12">
          ...
          <div className="flex flex-col items-center">
            <MannequinViewer
              ...
              sizeData={sizeData}
            />
            <p className="text-[11px] mt-4 text-center" style={{ color: "rgba(21,36,61,0.42)" }}>
              {selectedSize
          ...
          <div>
            ...
            <div className="mb-6">
              <p className="text-[10px] tracking-[0.2em] uppercase font-semibold mb-3" style={{ color: "rgba(36,139,212,0.65)" }}>
                SELECT YOUR SIZE
              </p>
              <div className="flex flex-wrap gap-2">
                {tab.data.map((row) => (
                  <button
                    ...
                    style={{
                      color: selectedSize === row.size ? "white" : "rgba(21,36,61,0.6)",
                      background:
                        selectedSize === row.size
                          ? "linear-gradient(135deg, rgba(36,139,212,0.2), rgba(255,158,184,0.12))"
                          : "transparent",
                      border:
                        selectedSize === row.size
                          ? "1px solid rgba(36,139,212,0.5)"
                          : "1px solid rgba(92,155,205,0.2)",
                      borderRadius: "10px",
                      boxShadow:
                        selectedSize === row.size
                          ? "0 0 12px rgba(36,139,212,0.15)"
                          : "none",
                    }}
                  >
                    {row.size}
                        ...
                        {tab.fields.map((field) => (
                          <td
                            ...
                            style={{
                              color:
                                field === "size"
                                  ? isSelected ? "white" : "rgba(21,36,61,0.82)"
                                  : isSelected ? "rgba(21,36,61,0.9)" : "rgba(21,36,61,0.6)",
        ...
        <div
          className="mb-12 p-6"
          style={{
            background: "linear-gradient(135deg, rgba(36,139,212,0.04), rgba(255,158,184,0.02))",
            border: "1px solid rgba(92,155,205,0.18)",
            borderRadius: "16px",
          }}
        >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.label}>
                ...
                <p className="text-[12px]" style={{ color: "rgba(21,36,61,0.5)" }}>
                  {item.desc}
                </p>
              </div>
            ))}
        ...
        >
          ...
          <ul className="space-y-2 text-[12px]" style={{ color: "rgba(21,36,61,0.5)" }}>
