...
export function CartPage() {
    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-6">
        ...
        <Link
          ...
          style={{
            background: "linear-gradient(135deg, rgba(74,143,217,0.12), rgba(255,190,170,0.08))",
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto px-6 lg:px-12 py-12">
      ...
      {/* Summary */}
      <div className="border-t pt-6" style={{ borderColor: "rgba(0,40,80,0.08)" }}>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <span className="text-[12px]" style={{ color: "rgba(74,143,217,0.55)" }}>Available at checkout</span>
        </div>
        ...
        <div className="flex justify-between items-center mb-8 pt-4" style={{ borderTop: "1px solid rgba(0,40,80,0.08)" }}>
        ...
        <button
          ...
          style={{
            background: "linear-gradient(135deg, #4a8fd9 0%, #5ba8e6 50%, #f5c97a 100%)",
