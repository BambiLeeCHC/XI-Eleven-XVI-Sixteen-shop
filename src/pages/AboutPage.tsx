...
function FlashText({
  ...
  const gradients = {
    primary: "linear-gradient(90deg, #b8943f, #e0c0ff, #fff, #e0c0ff, #b8943f)",
      ...
      <div className="min-h-screen">
        ...
        <section className="relative py-24 md:py-32 px-6 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 30% 20%, rgba(184,148,63,0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(255,180,170,0.05) 0%, transparent 45%), radial-gradient(ellipse at 50% 50%, rgba(245,201,122,0.03) 0%, transparent 40%), #FAF8F3",
            }}
          />
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <p
              ...
              style={{ color: "rgba(184,148,63,0.65)" }}
            >
              OUR STORY
            </p>
            <h1
        ...
        <section
          ...
          style={{
            background: "linear-gradient(#FAF8F3, #F5F0E6 40%, #FAF8F3 100%)",
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = "rgba(184,148,63,0.06)";
        ...
        <section
          className="py-20 px-6 relative overflow-hidden"
          style={{ borderTop: "1px solid rgba(184,148,63,0.06)" }}
        >
          <div
            className="absolute"
            style={{
                ...
                >
                  <p
                    ...
                    style={{
                      ...
                      background: "linear-gradient(135deg, #b8943f, #ff9eb8)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                    }}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <h3
                  ...
                  style={{
                    fontFamily: "var(--font-display)",
                    background: "linear-gradient(135deg, #b8943f, #e0c0ff)",
                    backgroundSize: "200% 100%",
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 mb-5">
                ...
                <span
                  ...
                  style={{
                    fontFamily: "var(--font-display)",
                    background: "linear-gradient(135deg, #b8943f, #ff9eb8, #f5c97a)",
                    backgroundSize: "200% 100%",
              ...
              {[
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.background = "rgba(184,148,63,0.03)";
        ...
        <section
          ...
          style={{
            background: "linear-gradient(#FAF8F3, #F5F0E6 50%, #FAF8F3 100%)",
            borderTop: "1px solid rgba(184,148,63,0.06)",
          }}
        >
          <Sparkles />
          ...
          <RevealSection className="relative z-10">
            ...
            <Link
              ...
              style={{
                background:
                  "linear-gradient(135deg, #b8943f 0%, #ff9eb8 50%, #f5c97a 100%)",
                backgroundSize: "200% 100%",
