  ...
  return (
    ...
    <div className="min-h-[80vh]">
      ...
      <div className="pt-12 pb-8 px-6 text-center">
        <p className="text-[10px] tracking-[0.3em] uppercase mb-2" style={{ color: "rgba(184, 148, 63, 0.45)" }}>COLLECTION</p>
        <h1 className="text-4xl md:text-6xl font-light text-[#1a1a2e] mb-2" style={{ fontFamily: "var(--font-display)" }}>
          {title}
        </h1>
        <p className="text-[12px]" style={{ color: "rgba(26, 26, 46, 0.28)" }}>{count} piece{count !== 1 ? "s" : ""}</p>
      </div>
        ...
        {(gender === "men" ? MEN_CATEGORIES : ALL_CATEGORIES).map((cat) => {
          ...
          return (
            <button
              ...
              style={{
                color: isActive ? "white" : "rgba(26, 26, 46, 0.4)",
                background: isActive
                  ? "linear-gradient(135deg, rgba(184,148,63,0.12), rgba(255,158,184,0.08))"
                  : "transparent",
                border: isActive
                  ? "1px solid rgba(184, 148, 63, 0.25)"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pb-20">
        {products === undefined ? (
          ...
          <div className="text-center py-20">
            <p className="text-[14px]" style={{ color: "rgba(26, 26, 46, 0.4)" }}>No products found.</p>
            <p className="text-[12px] mt-2" style={{ color: "rgba(26, 26, 46, 0.22)" }}>Check back soon — new pieces dropping regularly.</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                >
                  {product.images?.[0] ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <span className="text-4xl" style={{ color: "rgba(26, 26, 46, 0.1)" }}>✦</span>
                    </div>
                  )}
                  {/* Glass hover overlay */}
                  <div
                    ...
                    style={{
                      background: "linear-gradient(to top, rgba(250,251,254,0.5) 0%, transparent 50%)",
                      borderRadius: "13px",
                    }}
                  />
                </div>
                <h3 className="text-[12px] tracking-[0.1em] uppercase font-medium transition-colors" style={{ color: "rgba(26, 26, 46, 0.65)" }}>
                  {product.name}
                </h3>
                <p className="text-[12px] mt-1" style={{ color: "rgba(26, 26, 46, 0.35)" }}>
