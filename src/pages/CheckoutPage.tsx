    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-6">
        ...
        <Link
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(74,143,217,0.12), rgba(255,190,170,0.08))",
            border: "1px solid rgba(0,40,80,0.12)",
            borderRadius: "12px",
          }}
        >
            ...
            {i < 2 && (
              <div
                ...
                style={{
                  background:
                    step > num
                      ? "linear-gradient(90deg, #4a8fd9, #5ba8e6)"
                      : "rgba(0,40,80,0.08)",
                }}
              />
            )}
        ...
        <div className="lg:sticky lg:top-8 lg:self-start">
          <div className="p-5" style={glassCard}>
            ...
            <div
              ...
              style={{ borderBottom: "1px solid rgba(0,40,80,0.06)" }}
            >
              {cartItems.map((item: any) => (
                <div key={item._id} className="flex gap-3">
                  <div
            ...
            <div
              ...
              style={{
                borderTop: "1px solid rgba(0,40,80,0.08)",
              }}
            >
              <span
