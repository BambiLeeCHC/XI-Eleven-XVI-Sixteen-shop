  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: "linear-gradient(180deg, #F5F0E6 0%, #F5F0E6 40%, #F5F0E6 100%)" }}
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 pt-24 pb-20">
          ...
          <div className="text-center mb-16">
            <p
              ...
              style={{ color: "rgba(184,148,63,0.55)" }}
            >
              GET IN TOUCH
            </p>
            <h1
              ...
              style={{
                ...
                background: "linear-gradient(135deg, #fff 0%, rgba(26,26,46,0.85) 50%, rgba(184,148,63,0.7) 100%)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="md:col-span-1 flex flex-col gap-5">
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = "rgba(184,148,63,0.2)";
                  e.currentTarget.style.background = "rgba(184,148,63,0.04)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = "rgba(184,148,63,0.08)";
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div
                    style={{
                      ...
                      height: "36px",
                      borderRadius: "10px",
                      background: "linear-gradient(135deg, rgba(184,148,63,0.15), rgba(255,158,184,0.08))",
                      display: "flex",
                      alignItems: "center",
                ...
                <p className="text-[13px]" style={{ color: "rgba(26,26,46,0.7)" }}>
                  xixvi1116@icloud.com
                </p>
                <p className="text-[11px] mt-1" style={{ color: "rgba(26,26,46,0.3)" }}>
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div
                    style={{
                      ...
                      height: "36px",
                      borderRadius: "10px",
                      background: "linear-gradient(135deg, rgba(245,201,122,0.15), rgba(184,148,63,0.08))",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: "16px",
            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <p className="text-[12px] mb-8" style={{ color: "rgba(26,26,46,0.3)" }}>
                ...
                {status === "success" ? (
                  ...
                  >
                    ...
                    <p className="text-[13px]" style={{ color: "rgba(26,26,46,0.4)" }}>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onFocus={(e) => {
                            e.currentTarget.style.borderColor = "rgba(184,148,63,0.3)";
                            e.currentTarget.style.background = "rgba(184,148,63,0.04)";
                          }}
                          onBlur={(e) => {
                            e.currentTarget.style.borderColor = "rgba(184,148,63,0.1)";
                    ...
                    <button
                      ...
                      className="self-start px-8 py-3.5 text-[11px] tracking-[0.2em] uppercase font-bold text-[#1a1a2e] transition-all"
                      style={{
                        background:
                          status === "sending"
                            ? "rgba(184,148,63,0.3)"
                            : "linear-gradient(135deg, #b8943f, #ff9eb8)",
                        borderRadius: "12px",
                        border: "none",
