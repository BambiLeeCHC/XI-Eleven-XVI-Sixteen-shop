  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 text-center">
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-white/20 mb-6">
          <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
        </svg>
        <h2 className="text-lg font-semibold text-white/80 mb-2">Sign in to save favorites</h2>
        <p className="text-sm text-white/40 mb-6 max-w-sm">Create an account to save your favorite items and access them anytime.</p>
        <Link
          to="/login"
    ...
    <div className="max-w-6xl mx-auto px-6 lg:px-12 py-12">
      ...
      {favorites.length === 0 ? (
        <div className="text-center py-20">
          <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-white/10 mx-auto mb-6">
            <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
          </svg>
          <p className="text-white/30 text-sm mb-6">Browse our collections and tap the heart to save items you love.</p>
          <Link
            to="/shop"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {favorites.map((fav) => (
            ...
            >
              ...
              >
                <img
                  src={hiResProductImage(fav.product.images?.[0], 800)}
              ...
              <div className="p-4" onClick={() => navigate(`/product/${fav.productId}`)}>
                <h3 className="text-xs tracking-[0.1em] uppercase font-semibold text-white/80 mb-1 truncate">
                  {fav.product.name}
                </h3>
