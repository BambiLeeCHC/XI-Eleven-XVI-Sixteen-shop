...
export const THE_SPREAD: SpreadType = {
  ...
  slots: [
    { slot: "action", slotName: "Action", slotQuestion: "The action to ease this transition" },
    { slot: "support", slotName: "Support", slotQuestion: "What's supporting you through this" },
    { slot: "gain", slotName: "Gain", slotQuestion: "What you stand to gain" },
    { slot: "letgo", slotName: "Let Go", slotQuestion: "What you need to release" },
...
/**
 * Fresh seven-card draw for the Long Read from the full 78-card deck
 * (Major + Minor Arcana). Free daily five stays majors-only.
 */
