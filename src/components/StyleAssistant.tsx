        ...
        >
          ...
          <div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, rgba(168,85,247,0.08) 0%, rgba(184,148,63,0.04) 100%)",
            }}
          >
          ...
          <div className="p-3" style={{ borderTop: "1px solid rgba(168, 85, 247, 0.1)" }}>
            <form onSubmit={(e) => { e.preventDefault(); handleSend(); }} className="flex gap-2">
              ...
              <button
                ...
                className="px-3.5 py-2.5 text-sm font-bold text-[#1a1a2e] disabled:opacity-25 transition-all rounded-xl cursor-pointer"
