...
export function StoreHeader() {
  ...
  return (
    <>
      {/* Announcement Bar — Summer */}
      <div
        className="w-full py-2 px-4 text-center relative overflow-hidden"
        style={{
          background: "linear-gradient(90deg, #4a8fd9 0%, #5ba8e6 50%, #4a8fd9 100%)",
        }}
      >
        <p className="text-[10px] tracking-[0.3em] uppercase relative z-10 text-white font-medium">
          ✦ FREE STANDARD SHIPPING ON EVERY ORDER ✦
        </p>
      </div>

      {/* Main Nav — Light Summer */}
      <header className="relative z-30">
        <div
          ...
          style={{
            ...
            boxShadow: "0 1px 8px rgba(0, 40, 80, 0.04)",
          }}
        >
          <div
          ...
          >
            ...
            <div className="flex items-center gap-2 sm:gap-4 shrink-0">
              ...
              <nav className="hidden md:flex items-center gap-0.5 ml-2">
                <span className="w-px h-5 mx-2" style={{ background: "rgba(0,40,80,0.1)" }} />
                <Link
                  to="/shop?gender=women"
                  className={`px-3 py-2 text-[11px] tracking-[0.18em] uppercase font-semibold transition-all ${
                    location.search.includes("women") ? "text-[#1a1a2e]" : "text-[#1a1a2e]/50 hover:text-[#1a1a2e]"
                  }`}
                >
                  Women
                </Link>
                <Link
                  to="/shop?gender=men"
                  className={`px-3 py-2 text-[11px] tracking-[0.18em] uppercase font-semibold transition-all ${
                    location.search.includes("men") && !location.search.includes("women") ? "text-[#1a1a2e]" : "text-[#1a1a2e]/50 hover:text-[#1a1a2e]"
                  }`}
                >
                  Men
                </Link>
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              <button
                ...
                className="relative p-2 text-[#1a1a2e]/40 hover:text-[#1a1a2e] transition-colors group"
                aria-label="Search"
              >
              ...
              {/* Favorites icon */}
              <Link to="/favorites" className="relative p-2 text-[#1a1a2e]/40 hover:text-[#1a1a2e] transition-colors group">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-105 transition-transform">
                ...
                {favCount > 0 && (
                  <span
                    ...
                    style={{ background: "linear-gradient(135deg, #4a8fd9, #5ba8e6)" }}
                  >
                    {favCount}
                  </span>
                )}
              ...
              {/* Cart icon */}
              <Link to="/cart" className="relative p-2 text-[#1a1a2e]/40 hover:text-[#1a1a2e] transition-colors group">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:scale-105 transition-transform">
                ...
                <>
                  {isAdmin && (
                    <Link to="/admin" className="hidden md:block" title="Admin Dashboard">
                      <button
                        type="button"
                        className="relative p-2 text-amber-500/50 hover:text-amber-500 transition-all duration-300"
                      >
              ...
              <button
                type="button"
                className="md:hidden text-[#1a1a2e]/50 hover:text-[#1a1a2e] p-2 transition-colors"
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div
            ...
            style={{
              ...
              borderLeft: "1px solid rgba(0, 40, 80, 0.08)",
              boxShadow: "-8px 0 32px rgba(0,0,0,0.1)",
            }}
          >
            {/* Close button */}
            <div className="flex items-center justify-between px-6 h-[82px]" style={{ borderBottom: "1px solid rgba(0,40,80,0.06)" }}>
              <span className="text-[10px] tracking-[0.3em] uppercase" style={{ color: "rgba(26,26,46,0.3)" }}>MENU</span>
              <button
                onClick={() => setMobileOpen(false)}
            ...
            <nav className="flex-1 px-6 py-8 space-y-2">
              ...
              <div className="my-6" style={{ borderTop: "1px solid rgba(0,40,80,0.06)" }} />
              ...
              {isAuthenticated ? (
                <>
                  ...
                  {isAdmin && (
                    <>
                      <div className="my-4" style={{ borderTop: "1px solid rgba(245,158,11,0.15)" }} />
                      <Link
                        to="/admin"
                        className="flex items-center justify-between py-3 px-1 text-[11px] tracking-[0.2em] uppercase font-semibold text-amber-500/70 hover:text-amber-500 transition-colors"
                      >
            ...
            {/* Footer */}
            <div className="px-6 py-6" style={{ borderTop: "1px solid rgba(0,40,80,0.06)" }}>
              <p className="text-[9px] tracking-[0.2em] uppercase" style={{ color: "rgba(26,26,46,0.2)" }}>
